# TODO
**Todo** is a Ruby on Rails app that allows you to make lists, check them off when done and complete the list.
...
Clone the repo and cd into todo
...
Here is the app live on Heroku [checktodo.herokuapp.com]
